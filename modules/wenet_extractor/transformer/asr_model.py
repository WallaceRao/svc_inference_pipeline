...
class ASRModel(torch.nn.Module):
    ...
    def encoder_extractor(
        ...
        # print("raw encoder shape: ", encoder_out.shape)
        # encoder_out = encoder_out.transpose(1, 2)
        # encoder_out = F.interpolate(encoder_out, size=encoder_out.shape[2] * 6, mode='linear', align_corners=True)
        # encoder_out = encoder_out.transpose(1, 2)
        # print("interpolated encoder shape: ", encoder_out.shape)
